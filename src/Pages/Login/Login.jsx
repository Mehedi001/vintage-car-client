	...
	<div className="relative py-3 sm:max-w-xl sm:mx-auto">
		...
		<div className="relative px-4 py-10 bg-white shadow-lg sm:rounded-3xl sm:p-20">
			<div className="max-w-md mx-auto">
				<div>
					<h1 className="text-2xl font-thin">Already Seller ???  <br /> <span className="text-4xl font-bold text-[#709F9D]">Login Here</span></h1>
				</div>
				<div className="divide-y divide-gray-200">
					<div className="py-8 text-base leading-6 space-y-4 text-gray-700 sm:text-lg sm:leading-7">
						...
						<div className="relative">
							<button className="bg-[#709F9D] text-white rounded-md px-2 py-1">Login with Google</button>
						</div>
						<div className="relative">
							<button className="bg-[#709F9D] text-white rounded-md px-2 py-1">Login Now</button>
						</div>
					</div>
				</div>
			</div>
