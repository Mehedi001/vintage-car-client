            ...
            <form onSubmit={handleAddToy} className="w-full max-w-lg mx-0 lg:my-28 lg:mx-auto">
                ...
                <div className="flex flex-wrap lg:-mx-3 mb-6">
                    <div className="w-full px-3">
                        ...
                        <input className="appearance-none block w-full bg-gray-200 text-gray-700 border border-gray-200 rounded py-3 px-4 mb-3 leading-tight focus:outline-none focus:bg-white focus:border-gray-500" type="text" name="category" placeholder="sports car, polic car, regular car, mini fire car etc" />
